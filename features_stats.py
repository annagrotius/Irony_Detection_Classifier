...
def get_lemmas(doc):
    """Take nlp doc and return average number of Verb Lemmas within"""
...
def get_sentiment(dicts):
    """Take dictionary of comments and return list of sentiment classifications (positive=1/negative=-1)"""
    comment_list = []
